...
public class Task31 extends ImprovedTask implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new Task31(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        jobA.setJarByClass(Task31.class);
        ...
        jobB.setJarByClass(Task31.class);
    ...
    public static class PopularityCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // destination
            context.write(new Text(row[2].toUpperCase()), new IntWritable(1));
        }
    }
